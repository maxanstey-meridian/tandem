...
The Node registration contract gains a nested parallel node and moves from version 5 to version 6.
...
Add the typed `parallel()` API, recursive participant compilation, registration contract version 6,
