...
public sealed class RegisteredObservationObserverTests
{
    public static TheoryData<PipelineObservation, string> SupportedObservations =>
        new()
        {
            ...
            {
                new PipelineAgentUsage(Guid.Empty, "agent", 10, 5, 15, 200_000, 3),
                """{"version":1,"kind":"agentUsage","stepId":"agent","inputTokens":10,"outputTokens":5,"reasoningTokens":3,"currentContextTokens":15,"contextWindowTokens":200000}"""
            },
            {
                new PipelineAgentUsage(Guid.Empty, "agent", 10, 5, 15),
                """{"version":1,"kind":"agentUsage","stepId":"agent","inputTokens":10,"outputTokens":5,"reasoningTokens":0,"currentContextTokens":15,"contextWindowTokens":null}"""
            },
            {
