...
This project is indexed by GitNexus as **tandem** (4674 symbols, 12130 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
